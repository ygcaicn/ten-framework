...
<details>
  <summary><kbd>TEN Agent + Dify Agent con RAG</kbd></summary>

  <br>
  <picture>

  ![Dify con RAG](https://github.com/TEN-framework/docs/blob/main/assets/gif/dify-rag.gif?raw=true)
...
<details>
  ...
  ![Casi d'uso](https://github.com/TEN-framework/docs/blob/main/assets/gif/gemini.gif?raw=true)
...
<details>
  <summary><kbd>Storyteller + Generatore di Immagini</kbd></summary>

  <br>
  <picture>

  ![Casi d'uso](https://github.com/TEN-framework/docs/blob/main/assets/jpg/storyteller_image_generator.jpg?raw=true)
