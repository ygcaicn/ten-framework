...
<details>
  <summary><kbd>Gemini 2.0 多模态实时 API</kbd></summary>

  <br>
  <picture>

![用例](https://github.com/TEN-framework/docs/blob/main/assets/gif/gemini.gif?raw=true)
...
<details>
  <summary><kbd>故事讲述者 + 图像生成器</kbd></summary>

  <br>
  <picture>

![用例](https://github.com/TEN-framework/docs/blob/main/assets/jpg/storyteller_image_generator.jpg?raw=true)
...
![模块选择器示例](https://github.com/TEN-framework/docs/blob/main/assets/gif/module-example.gif?raw=true)
