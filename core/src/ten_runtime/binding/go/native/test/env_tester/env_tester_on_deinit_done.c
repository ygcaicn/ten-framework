...
static void ten_go_ten_env_tester_on_deinit_done_proxy_notify(
  ...
  ten_go_ten_env_tester_t *go_ten_env_tester = user_data;
  TEN_ASSERT(go_ten_env_tester, "Should not happen.");

  // TODO(xilin): consider the thread safety of c_ten_env_tester_proxy.
  ten_env_tester_proxy_release(go_ten_env_tester->c_ten_env_tester_proxy, NULL);
  go_ten_env_tester->c_ten_env_tester_proxy = NULL;
...
ten_go_error_t ten_go_ten_env_tester_on_deinit_done(uintptr_t bridge_addr) {
  ...
  bool rc = ten_env_tester_proxy_notify(
      ...
      ten_go_ten_env_tester_on_deinit_done_proxy_notify, self, &err);
