...
def _ten_py_msg_register_msg_type(cls: type) -> None: ...
def _ten_py_cmd_register_cmd_type(cls: type) -> None: ...
def _ten_py_cmd_result_register_cmd_result_type(cls: type) -> None: ...
def _ten_py_data_register_data_type(cls: type) -> None: ...
def _ten_py_video_frame_register_video_frame_type(cls: type) -> None: ...
def _ten_py_audio_frame_register_audio_frame_type(cls: type) -> None: ...
def _ten_py_ten_env_register_ten_env_type(cls: type) -> None: ...
def _ten_py_ten_env_tester_register_ten_env_tester_type(cls: type) -> None: ...
def _ten_py_error_register_error_type(cls: type) -> None: ...
