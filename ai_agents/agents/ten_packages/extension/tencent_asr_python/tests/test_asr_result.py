...
from tests.mock import patch_tencent_asr_client  # noqa: F401


class TencentAsrExtensionTester(AsyncExtensionTester):
...
def test_asr_result(patch_tencent_asr_client):
    ...
    tester.set_test_mode_single("tencent_asr_python", json.dumps(property_json))
    err = tester.run()
