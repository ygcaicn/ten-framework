...
def test_text_input_end_logic(MockBytedanceV3Client):
    ...
    def mock_client_init(config, ten_env, vendor, response_msgs):
        ...
        mock_instance.send_text = AsyncMock(side_effect=mock_send_text_with_queue_population)
...
def test_flush_logic(MockBytedanceV3Client):
    ...
    assert tester.audio_end_reason == 2, f"Expected audio end reason 'flush', but got '{tester.audio_end_reason}'"
