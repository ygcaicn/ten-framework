...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(return_1__extension_1, test_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(return_1__extension_2, test_extension_2);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(return_1__extension_3, test_extension_3);

}  // namespace

TEST(ExtensionTest, Return1) {  // NOLINT
  // Start app.
  auto *app_thread =
  ...
  start_graph_cmd->set_graph_from_json(R"({
           "nodes": [{
               ...
               "addon": "return_1__extension_1",
               "app": "msgpack://127.0.0.1:8001/",
               "extension_group": "test_extension_group"
             },{
               "type": "extension",
               "name": "test_extension_2",
               "addon": "return_1__extension_2",
               "app": "msgpack://127.0.0.1:8001/",
               "extension_group": "test_extension_group"
             },{
               "type": "extension",
               "name": "test_extension_3",
               "addon": "return_1__extension_3",
               "app": "msgpack://127.0.0.1:8001/",
               "extension_group": "test_extension_group"
             }],
             "connections": [{
