  ...
  void on_start(ten::ten_env_t &ten_env) override {
    ...
    start_graph_cmd->set_graph_from_json(R"({
      "nodes": [{
        ...
        "addon": "start_incorrect_graph_2__test_extension_2",
        "app": "msgpack://127.0.0.1:8001/",
        "extension_group": "start_incorrect_graph_2__normal_extension_group"
      }]
    })"_json.dump()
               ...
               "predefined_graphs": [{
                 ...
                 "graph": {
                   "nodes": [{
                     ...
                     "addon": "start_incorrect_graph_2__test_extension_1",
                     "extension_group": "start_incorrect_graph_2__test_extension_1_group"
                   }]
                 }
               }]
             }
...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(start_incorrect_graph_2__test_extension_1,
                                    test_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(start_incorrect_graph_2__test_extension_2,
                                    test_extension_2);
