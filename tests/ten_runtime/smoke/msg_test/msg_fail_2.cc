...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(msg_fail_2__extension, test_extension);

}  // namespace

TEST(MsgTest, MsgFail2) {
  auto *app_thread =
  ...
  start_graph_cmd->set_graph_from_json(R"({
           "nodes": [{
               "type": "extension",
               "name": "test_extension",
               "addon": "msg_fail_2__extension",
               "app": "msgpack://127.0.0.1:8001/",
               "extension_group": "msg_fail_2__extension_group"
             }]
           })");
  auto cmd_result =
