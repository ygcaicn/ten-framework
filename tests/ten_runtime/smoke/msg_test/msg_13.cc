...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(msg_13__extension_1, test_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(msg_13__extension_2, test_extension_2);

}  // namespace

TEST(MsgTest, Msg13) {  // NOLINT
  // Start app.
  auto *app_thread =
  ...
  start_graph_cmd->set_graph_from_json(R"({
           "nodes": [{
               "type": "extension",
               "name": "msg_13__extension_1",
               "addon": "msg_13__extension_1",
               "app": "msgpack://127.0.0.1:8001/",
               "extension_group": "msg_13__extension_group_1"
             },{
               "type": "extension",
               "name": "msg_13__extension_2",
               "addon": "msg_13__extension_2",
               "app": "msgpack://127.0.0.1:8001/",
               "extension_group": "msg_13__extension_group_2"
             }],
             "connections": [{
               "app": "msgpack://127.0.0.1:8001/",
               "extension": "msg_13__extension_1",
               "cmd": [{
                 "name": "test",
                 "dest": [{
                   "app": "msgpack://127.0.0.1:8001/",
                   "extension": "msg_13__extension_2"
                 }]
               }]
             }]
           })");
  ...
  hello_world_cmd->set_dests(
      {{"msgpack://127.0.0.1:8001/", nullptr, "msg_13__extension_1"}});
