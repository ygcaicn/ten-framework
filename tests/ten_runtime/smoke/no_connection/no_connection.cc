 ...
 public:
  ...
  void on_configure(ten::ten_env_t &ten_env) override {
    ...
    bool rc = ten::ten_env_internal_accessor_t::init_manifest_from_json(ten_env,
                 R"({
                      "type": "extension",
                      "name": "no_connection__extension_1",
                      "version": "0.1.0",
                      "api": {
                        "cmd_out": [
                          {
...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(no_connection__extension_1,
                                    test_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(no_connection__extension_2,
                                    test_extension_2);

}  // namespace

TEST(NoConnectionTest, NoConnection) {  // NOLINT
  // Start app.
  auto *app_thread =
  ...
  start_graph_cmd->set_graph_from_json(R"({
           "nodes": [{
               "type": "extension",
               "name": "no_connection__extension_1",
               "addon": "no_connection__extension_1",
               "app": "msgpack://127.0.0.1:8001/",
               "extension_group": "no_connection__extension_group_1"
             },{
               "type": "extension",
               "name": "no_connection__extension_2",
               "addon": "no_connection__extension_2",
               "app": "msgpack://127.0.0.1:8001/",
               "extension_group": "no_connection__extension_group_2"
             }]
           })");
  auto cmd_result =
  ...
  hello_world_cmd->set_dests(
      {{"msgpack://127.0.0.1:8001/", nullptr, "no_connection__extension_1"}});
