...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    basic_two_standalone_extension_2__test_extension_1, test_extension_1);

TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    basic_two_standalone_extension_2__test_extension_2, test_extension_2);

}  // namespace

TEST(BasicTest, TwoStandaloneExtension2) {  // NOLINT
  // Start app.
  auto *app_thread =
