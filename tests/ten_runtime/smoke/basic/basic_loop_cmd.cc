    ...
    if (cmd->get_name() == "hello_world_1") {
      ...
      ten_env.send_cmd(
          ...
          [this](ten::ten_env_t &ten_env,
            ...
            auto cmd_result_for_hello_world =
                ten::cmd_result_t::create(TEN_STATUS_CODE_OK, *pending_request);
            cmd_result_for_hello_world->set_property("detail",
                                                     "hello world, too");
            ten_env.return_result(std::move(cmd_result_for_hello_world));
          });
...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(basic_loop_cmd__extension_1,
                                    test_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(basic_loop_cmd__extension_2,
                                    test_extension_2);
...
TEST(BasicTest, LoopCmd) {  // NOLINT
  ...
  start_graph_cmd->set_graph_from_json(R"({
           "nodes": [{
               ...
               "addon": "basic_loop_cmd__extension_1",
               "app": "msgpack://127.0.0.1:8001/",
               "extension_group": "test_extension_group"
             },{
               "type": "extension",
               "name": "test_extension_2",
               "addon": "basic_loop_cmd__extension_2",
               "app": "msgpack://127.0.0.1:8001/",
               "extension_group": "test_extension_group"
             }],
             "connections": [{
