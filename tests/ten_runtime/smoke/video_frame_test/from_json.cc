...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(video_frame_from_json__test_extension_1,
                                    test_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(video_frame_from_json__test_extension_2,
                                    test_extension_2);

}  // namespace

TEST(VideoFrameTest, FromJson) {  // NOLINT
  // Start app.
  auto *app_thread =
