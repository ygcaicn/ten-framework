...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(telemetry_multi_app__extension_1,
                                    test_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(telemetry_multi_app__extension_2,
                                    test_extension_2);

}  // namespace

TEST(TelemetryTest, MultiApp) {  // NOLINT
    ...
    for (size_t i = 0; i < MULTIPLE_APP_SCENARIO_GRAPH_CONSTRUCTION_RETRY_TIMES;
      ...
      start_graph_cmd->set_graph_from_json(R"({
        "nodes": [{
          ...
          "addon": "telemetry_multi_app__extension_1",
          "app": "msgpack://127.0.0.1:8001/",
          "extension_group": "test_extension_group 1"
        },{
          "type": "extension",
          "name": "test_extension_2",
          "addon": "telemetry_multi_app__extension_2",
