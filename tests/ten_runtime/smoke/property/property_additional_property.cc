...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    property_additional_property__test_extension, test_extension);

}  // namespace

TEST(PropertyTest, AdditionalProperty) {  // NOLINT
  auto *app_thread =
  ...
  start_graph_cmd->set_graph_from_json(R"({
           "nodes": [{
                "type": "extension",
                "name": "test_extension",
                "addon": "property_additional_property__test_extension",
