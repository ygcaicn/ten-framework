...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(data_create_from_json__test_extension_1,
                                    test_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(data_create_from_json__test_extension_2,
                                    test_extension_2);

}  // namespace

TEST(DataTest, CreateFromJson) {  // NOLINT
  // Start app.
  auto *app_thread =
  ...
  start_graph_cmd->set_graph_from_json(R"({
           "nodes": [{
                ...
                "addon": "data_create_from_json__test_extension_1",
                "extension_group": "basic_extension_group",
                "app": "msgpack://127.0.0.1:8001/"
             },{
                "type": "extension",
                "name": "test_extension_2",
                "addon": "data_create_from_json__test_extension_2",
                "extension_group": "basic_extension_group",
                "app": "msgpack://127.0.0.1:8001/"
             }],
             "connections": [{
