...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(graph_out_of_order_2__test_extension_1,
                                    test_extension_1);

TEN_CPP_REGISTER_ADDON_AS_EXTENSION(graph_out_of_order_2__test_extension_2,
                                    test_extension_2);

}  // namespace

TEST(ExtensionTest, GraphOutOfOrder2) {  // NOLINT
  // Start app.
  auto *app_thread =
  ...
  start_graph_cmd->set_graph_from_json(R"({
           "nodes": [{
                ...
                "addon": "graph_out_of_order_2__test_extension_1",
