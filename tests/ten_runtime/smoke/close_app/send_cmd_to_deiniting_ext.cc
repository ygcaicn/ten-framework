...
class test_extension_2 : public ten::extension_t {
 public:
  ...
  void on_stop(ten::ten_env_t &ten_env) override {
    // Sleep seconds to ensure the test_extension_1 is deiniting.
    ten_sleep_ms(1000);
...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(send_cmd_to_deiniting_ext__test_extension_1,
                                    test_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(send_cmd_to_deiniting_ext__test_extension_2,
                                    test_extension_2);

}  // namespace

TEST(CloseAppTest, SendCmdToDeinitingExt) {  // NOLINT
  // Start app.
  auto *app_thread =
  ...
  start_graph_cmd->set_graph_from_json(R"({
           "nodes": [{
                ...
                "addon": "send_cmd_to_deiniting_ext__test_extension_1",
                "extension_group": "basic_extension_group_1",
                "app": "msgpack://127.0.0.1:8001/"
             },{
                "type": "extension",
                "name": "test_extension_2",
                "addon": "send_cmd_to_deiniting_ext__test_extension_2",
