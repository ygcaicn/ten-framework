  ...
  void on_start(ten::ten_env_t &ten_env) override {
    ...
    start_graph_cmd->set_graph_from_json(R"({
      "nodes": [{
        ...
        "addon": "start_graph_with_reversed_connection__normal_extension_1",
        "extension_group": "start_graph_with_reversed_connection__normal_extension_group_1"
      }, {
        "type": "extension",
        "name": "normal_extension_2",
        "addon": "start_graph_with_reversed_connection__normal_extension_2",
        "extension_group": "start_graph_with_reversed_connection__normal_extension_group_2"
      }, {
        "type": "extension",
        "name": "normal_extension_3",
        "addon": "start_graph_with_reversed_connection__normal_extension_3",
        "extension_group": "start_graph_with_reversed_connection__normal_extension_group_3"
      }],
      "connections": [
        {
                        ...
                        "predefined_graphs": [{
                          ...
                          "graph": {
                            "nodes": [{
                              ...
                              "addon": "start_graph_with_reversed_connection__predefined_graph_extension",
                              "extension_group": "start_graph_with_reversed_connection__predefined_graph_group"
                            }]
                          }
                        }]
                      }
...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    start_graph_with_reversed_connection__predefined_graph_extension,
    test_predefined_graph);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    start_graph_with_reversed_connection__normal_extension_1,
    test_normal_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    start_graph_with_reversed_connection__normal_extension_2,
    test_normal_extension_2);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    start_graph_with_reversed_connection__normal_extension_3,
    test_normal_extension_3);

}  // namespace

TEST(GraphSyntaxSugarTest, StartGraphWithReversedConnection) {  // NOLINT
