...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    graph_with_reversed_connection_2__extension_1, test_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    graph_with_reversed_connection_2__extension_2, test_extension_2);

}  // namespace

TEST(GraphSyntaxSugarTest, GraphWithReversedConnection2) {  // NOLINT
  // Start app.
  auto *app_thread =
