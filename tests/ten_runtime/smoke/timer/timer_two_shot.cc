...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(timer_two_shot__extension, test_extension);

}  // namespace

TEST(ExtensionTest, TimerTwoShot) {  // NOLINT
  auto *app_thread =
  ...
  start_graph_cmd->set_graph_from_json(R"({
           "nodes": [{
               "type": "extension",
               "name": "test_extension",
               "addon": "timer_two_shot__extension",
               "app": "msgpack://127.0.0.1:8001/",
               "extension_group": "timer_two_shot__extension_group"
             }]
           })");
  auto cmd_result =
