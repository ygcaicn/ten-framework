...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    thirty_two_threads_attempt_to_suspend_1__test_extension_1,
    test_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    thirty_two_threads_attempt_to_suspend_1__test_extension_2,
    test_extension_2);

}  // namespace

TEST(OuterThreadTest, ThirtyTwoThreadsAttemptToSuspend1) {  // NOLINT
  // Start app.
  auto *app_thread =
