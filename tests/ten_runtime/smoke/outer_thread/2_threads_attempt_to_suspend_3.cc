 ...
 public:
  ...
  void outer_thread1_main(ten::ten_env_proxy_t *ten_env_proxy) {  // NOLINT
    ...
    *test_data = TEST_DATA_VALUE;
    ...
    if (!outer_thread_towards_to_close) {
...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    two_threads_attempt_to_suspend_3__test_extension_1, test_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    two_threads_attempt_to_suspend_3__test_extension_2, test_extension_2);
...
TEST(OuterThreadTest, TwoThreadsAttemptToSuspend3) {  // NOLINT
  ...
  start_graph_cmd->set_graph_from_json(R"({
           "nodes": [{
               ...
               "addon": "two_threads_attempt_to_suspend_3__test_extension_1",
               "app": "msgpack://127.0.0.1:8001/",
               "extension_group": "basic_extension_group"
             },{
               "type": "extension",
               "name": "test_extension_2",
               "addon": "two_threads_attempt_to_suspend_3__test_extension_2",
               "app": "msgpack://127.0.0.1:8001/",
               "extension_group": "basic_extension_group"
             }],
             "connections": [{
