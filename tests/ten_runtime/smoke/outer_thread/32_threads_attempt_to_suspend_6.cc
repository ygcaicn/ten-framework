...
#define FROM_EXTENSION_2_CMD_CNT 10
#define OUTER_THREAD_CNT 32
...
class test_extension_2 : public ten::extension_t {
 public:
  explicit test_extension_2(const char *name)
  ...
  void on_cmd(ten::ten_env_t &ten_env,
    ...
    if (cmd->get_name() == std::string("start_to_send")) {
      ...
      ten_env.send_cmd(std::move(timer_cmd));
               ...
               static_cast<ten::timeout_cmd_t *>(cmd.get())->get_timer_id() ==
                   55) {
...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    thirty_two_threads_attempt_to_suspend_6__test_extension_1,
    test_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    thirty_two_threads_attempt_to_suspend_6__test_extension_2,
    test_extension_2);

}  // namespace

TEST(OuterThreadTest, ThirtyTwoThreadsAttemptToSuspend6) {  // NOLINT
  // Start app.
  auto *app_thread =
  ...
  start_graph_cmd->set_graph_from_json(R"({
           "nodes": [{
               ...
               "addon": "thirty_two_threads_attempt_to_suspend_6__test_extension_1",
               "app": "msgpack://127.0.0.1:8001/",
               "extension_group": "basic_extension_group"
             },{
               "type": "extension",
               "name": "test_extension_2",
               "addon": "thirty_two_threads_attempt_to_suspend_6__test_extension_2",
               "app": "msgpack://127.0.0.1:8001/",
               "extension_group": "basic_extension_group"
             }],
             "connections": [{
