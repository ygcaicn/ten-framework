"""
Test metadata_additional_field_app.
"""
...
def test_metadata_additional_field_app():
    ...
    app_dir_name = "metadata_additional_field_app"
    ...
    if sys.platform == "win32":
        ...
        if (
            ...
            libasan_path = os.path.join(
                base_path,
                (
                    "metadata_additional_field_app/ten_packages/system/"
    ...
    if not is_started:
        ...
        print("The exit code of metadata_additional_field_app: ", exit_code)
