...
def test_graph_env_var_3_app():
    ...
    if sys.platform == "win32":
        my_env["PATH"] = (
            os.path.join(
                base_path,
                "graph_env_var_3_app/ten_packages/system/ten_runtime/lib",
            )
            + ";"
            + my_env["PATH"]
        )
        ...
        if (
            ...
            libasan_path = os.path.join(
                base_path,
                (
                    "graph_env_var_3_app/ten_packages/"
    ...
    if not is_started:
        ...
        print(
            "The exit code of graph_env_var_3_app: ",
            exit_code,
        )
