"""
Test standalone_test_tmpl_async_python.
"""
...
def test_standalone_test_tmpl_async_python():
    base_path = os.path.dirname(os.path.abspath(__file__))
    root_dir = os.path.join(base_path, "../../../../../")

    extension_name = "example_extension_python"
    ...
    # Step 1:
    #
    # Create example_extension_python package directly.
    tman_create_cmd = [
