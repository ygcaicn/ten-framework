...
class DefaultExtension(Extension):
    def on_init(self, ten_env: TenEnv) -> None:
        ...
        ten_env.log(LogLevel.INFO, f"audio duration: {len(self.audio)}")
    ...
    def on_cmd(self, ten_env: TenEnv, cmd: Cmd) -> None:
        ...
        ten_env.log(LogLevel.INFO, f"audio raw data len: {len(raw_data)}")
    ...
    def on_audio_frame(self, ten_env: TenEnv, audio_frame: AudioFrame) -> None:
        ten_env.log(LogLevel.INFO, "DefaultExtension on_audio_frame")
    ...
    def on_stop(self, ten_env: TenEnv) -> None:
        ten_env.log(LogLevel.INFO, "DefaultExtension on_stop")
